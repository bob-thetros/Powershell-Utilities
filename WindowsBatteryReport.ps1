...
$LogFile      = Join-Path $LogBase "\reports\$($env:COMPUTERNAME)-Battery-$DateStamp.html"

# Create the report → store in %TEMP%\BatteryReport.html
powercfg /batteryreport /output "$LogFile"

# Launch Microsoft Edge to display the report
Start-Process -FilePath "msedge.exe" -ArgumentList "$($LogFile)"

# SIG # Begin signature block
# MIIFuwYJKoZIhvcNAQcCoIIFrDCCBagCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU7U1OIGXyeVkRt4b5Is2Exu5e
...
# BAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUprLC4c2CnUXYPqydCOqcCaCKp+owDQYJ
# KoZIhvcNAQEBBQAEggEAltkADzkAWZybBXzo6Swv8IccR7LtSaVKwVC14fvnJ20Z
# djMUQ1/r9PBCpnX2ZwTJojF+29M87OWNWtDdRZjd4XWcbIregLdNzqh+wwU6maP1
# 4G4Wz2Ln6GPWxoyYO48kQCEkImGFLBefQBaQEt+ZW6Ia/Nl0iFl7tDCUiXJKQlcg
# 6kfpexnKPy65qwHC7spFJEPoEoQjpcqLcuzuXuGvS/UrqhZDx6PJdJZWlopemv1T
# O4c5G7GXfMfo8bgxUj1DzL79UCfId+jlhUQKDeIiVPMe12KcSKnOYdXSXxH+ikSu
# fJYWcdbZP1E1ZDoXUC0wc1LXr28rFSZuzjnpRG3GCw==
